"""GRU-AE adapter (parameterized; works for any DatasetProfile)."""
...
class GRUAdapter:
    ...
    def fit(
        ...
        **kwargs: Any,
        ...
        val_flat = self._as_flat(val_windows) if val_windows is not None and len(val_windows) else None
        ...
        return FitResult(threshold=float(self._model.threshold), train_loss=last_loss, val_fpr=val_fpr)
